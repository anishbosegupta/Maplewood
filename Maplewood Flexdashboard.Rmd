...
Technology Adoption {data-orientation=rows}
======================================================================
...
### Income
```{r}
selectInput("Income3",label = NULL,
            choices = income_group,selected = "$60,000 - $79,999")
```
...
### Outside lightbulbs controlled by motion detectors or light sensors
```{r}
...
#Donut Chart
renderBillboarder(billboarder() %>% 
  bb_donutchart(outside_bulbs()) %>% 
